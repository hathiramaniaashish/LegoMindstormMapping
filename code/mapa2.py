...
contador_log = 1;
#constantes
log_depuracion = open("log_mapa_2/log_depuracion.txt", "w");
log_sensor1 = open("log_mapa_2/log_sensor1.txt", "w");
log_sensor2 = open("log_mapa_2/log_sensor2.txt", "w");
log_sensor3 = open("log_mapa_2/log_sensor3.txt", "w");
log_sensor4 = open("log_mapa_2/log_sensor4.txt", "w");
angle = 10;
correction_speed = 25;
normal_speed = 100;
rotate_complete = 69;
